package com.cdyykj.commons.upyun;
...
public class UpYun {
	...
	public static final String DEFAULT_BUCKET_NAME = "benes";
	public static final String DEFAULT_USER_NAME = "admin";
	public static final String DEFAULT_PASSWORD="benecess2017";
	...
	* 获取单例又拍云帮助类
	* @author BILL CHEN
	* @date 2016年5月18日 下午6:07:34
	* 参数说明 
	* 
	* @return  
	*/
	public static UpYun getInstance(){
		if(null == upYun){
			upYun = new UpYun();
		}
		return upYun;
	...
	public boolean writeFile(String filePath, File file, boolean auto,
		...
		try {
			// 上传成功
			return writeFile(filePath, new FileInputStream(file), auto, params);
		} catch (IOException e) {
			if (debug)
				e.printStackTrace();
			// 上传失败
	...
	public boolean writeFile(String filePath, MultipartFile multipartFile, boolean auto) {
		...
		return writeFile(filePath, multipartFile, auto, null);
	}
	
	/** 
	* @Description: 
	* @author BILL CHEN
	* @date 2016年5月18日 下午6:14:26
	* 参数说明 
	* 
	* @param filePath
	* @param multipartFile
	...
	*/
	public boolean writeFile(String filePath, MultipartFile multipartFile, boolean auto,
		...
		try {
			return writeFile(filePath,multipartFile.getInputStream(), auto, params);
	...
	public boolean writeFile(String filePath, InputStream is, boolean auto) throws IOException {
		return writeFile(filePath, is, auto, null);
	}
